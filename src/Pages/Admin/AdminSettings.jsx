        ...
        <div className='w-full'>
                ...
                <div className='flex w-full mobile:flex-col tablet:flex-col'>
                  ...
                  <div className='rounded-md w-[65%] bg-white p-4 flex flex-col gap-8'>
                    <div>
                        <div className='font-medium text-[18px]'>Admin configuration settings</div>
                        <div className='font-normal text-[16px] text-gray-500'>Admin configuration settings</div>
                        <input className='w-full p-2 border rounded-md mt-4'  type="text" placeholder='Admin configuration settings' />
                    </div>
                    <div>
                        <div className='font-medium text-[18px] flex items-center gap-2'>Admin configuration settings</div>
                        <input className='w-full p-2 border rounded-md mt-4'  type="text" placeholder='Admin configuration settings' />
                    </div>

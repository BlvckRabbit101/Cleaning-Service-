...
const Hero = () => {
  return (
    <div className='flex justify-center items-center w-full bg-[url("C:\Users\USER\Desktop\ReactJs\Cleaning\client\src\assets\images\herobg4.jpg")] h-[100vh] bg-cover mobile:h-[80vh] tablet:h-[80vh]' id='Hero'>

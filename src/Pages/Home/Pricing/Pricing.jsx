  ...
  return (
    <div className='flex justify-center items-center w-full bg-white py-[15px] ' id='Pricing'>
        <div className='flex flex-col justify-start items-center w-[80%] font-[16px] py-[100px] mobile:py-[50px] tablet:py-[50px]'>
            <div className='flex flex-col text-[32px] justify-start items-center text-center mb-[50px] w-[600px] font-bold gap-[15px] mobile:w-full mobile:gap-[5px] tablet:w-full tablet:gap-[5px]'>
                <div className='text-[18px] font-medium text-center text-[#032B56]'>CLEANING PLANS</div>

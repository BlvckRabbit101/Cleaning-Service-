    ...
    <div class="w-full h-screen pb-8 bg-gray-100 flex items-center justify-center">
        <div class="py-6 h-[380px] w-[500px] bg-white rounded-lg shadow-xl flex-col items-center justify-center text-center">
            ...
            <div className='flex items-center justify-center gap-12 w-full mt-8 '>
              ...
              <Link to='/AccountVerified'><button className='py-2 px-12 rounded-2xl text-sm text-[#032B56] font-medium bg-transparent border border-[#032B56] hover:bg-[#4291fd] hover:text-white hover:border-[#4291fd] duration-200'>Okay, go back</button></Link>
            </div>
        </div>
    </div>
  )

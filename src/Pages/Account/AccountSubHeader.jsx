...
const AccountSubHeader = ({handleChange}) => {
        ...
        <div className='flex-col justify-center items-start w-[90%] pt-4 font-normal text-[16px] '>
           ...
           <div className='flex w-full justify-between items-start gap-[30px]'>
                ...
                <div className='flex justify-start items-center gap-[15px] font-medium'>
                    <div>Filter by: </div>
                    <select onChange={handleChange} name="availability" id="availability" className='w-[150px] flex-col justify-center items-center text-sm font-medium text-center text-gray-900 bg-gray-100 border py-[5px] px-[10px] border-gray-300 rounded-2xl hover:bg-gray-200 duration-700 '>
                    ...
                    <select onChange={handleChange} name="category" id="category" className='w-[150px] flex-col justify-center items-center text-sm font-medium text-center text-gray-900 bg-gray-100 border py-[5px] px-[10px] border-gray-300 rounded-2xl hover:bg-gray-200 duration-700 '>
                    ...
                    <select onChange={handleChange} name='location' id="location" className='w-[150px] flex-col justify-center items-center text-sm font-medium text-center text-gray-900 bg-gray-100 border py-[5px] px-[10px] border-gray-300 rounded-2xl hover:bg-gray-200 duration-700 '>

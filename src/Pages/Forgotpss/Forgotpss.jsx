...
const Forgotpss = () => {
  return (
    <div className='flex justify-center items-center w-full bg-[#EEF8FF] h-[100vh] mobile:py-0 mobile:h-screen tablet:py-0 tablet:h-screen'>
        <div className='flex justify-center items-center w-[80%] font-[16px] mobile:w-full mobile:h-screen tablet:w-full tablet:h-screen '>
           <div className='flex justify-center items-center w-[100%] h-[350px] bg-white text-white mobile:flex-col mobile:w-full mobile:h-auto tablet:flex-col tablet:w-full tablet:h-auto'>
                <div className='w-[50%] h-full bg-[url("C:\Users\USER\Desktop\ReactJs\Cleaning\client\src\assets\images\bluebg.jpg")] bg-cover flex flex-col justify-center items-center gap-[0px] opacity-90 mobile:w-full mobile:text-[14px] mobile:py-[20px] tablet:w-full tablet:text-[16px] tablet:py-[40px]'>
                ...
                <div className='w-[50%] h-full text-[#333] flex flex-col justify-center items-start p-[50px] gap-[10px] mobile:w-full mobile:px-[20px] tablet:w-full tablet:py-[20px]'>
                    <NavLink to='/Login'><FaArrowLeftLong /></NavLink>
                    ...
                    <form className='w-full'>
                        ...
                        <div className="flex flex-col items-start justify-start gap-[10px] mt-[30px]">
                            <button className="rounded-3xl w-full bg-[#4291FD] hover:bg-transparent border-[2px] border-solid border-[#4291FD] hover:text-[#4291FD] duration-300 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline" type="button">
                                    Reset Password
                            </button>

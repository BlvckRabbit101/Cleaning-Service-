...
const Forgotpss = () => {
  return (
    <div className='flex justify-center items-center w-full bg-[url("C:\Users\USER\Desktop\ReactJs\Cleaning\client\src\assets\images\pattern4.png")] bg-contain h-[100vh] mobile:py-0 mobile:h-screen tablet:py-0 tablet:h-screen'>
        <div className='flex justify-center items-center w-full font-[16px] mobile:w-full mobile:h-screen tablet:w-full tablet:h-screen '>

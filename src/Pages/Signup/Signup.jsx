...
const Signup = () => {
  return (
    <div className='flex justify-center items-center w-full bg-[#EEF8FF] h-auto mobile:py-0 mobile:h-auto tablet:py-0 tablet:h-auto'>
        <div className='flex justify-center items-center w-[80%] h-auto font-[16px] mobile:w-full mobile:h-auto tablet:w-full tablet:h-auto '>
           <div className='flex justify-center items-center w-[100%] h-[600px] bg-white text-white mobile:flex-col mobile:w-full mobile:h-auto tablet:flex-col tablet:w-full tablet:h-auto'>

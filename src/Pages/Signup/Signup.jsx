...
const Signup = () => {
  return (
    <div className='flex justify-center items-center w-full h-screen bg-[url("C:\Users\USER\Desktop\ReactJs\Cleaning\client\src\assets\images\pattern4.png")] bg-contain  mobile:py-0 mobile:h-auto tablet:py-0 tablet:h-auto'>
        <div className='flex justify-center items-center w-full h-auto font-[16px] mobile:w-full mobile:h-auto tablet:w-full tablet:h-auto '>
           <div className='flex justify-center items-center w-screen h-screen  bg-white text-white mobile:flex-col mobile:w-full mobile:h-auto tablet:flex-col tablet:w-full tablet:h-auto'>
                ...
                <div className='w-[50%] h-full text-[#333] flex flex-col justify-center items-start px-[50px] gap-[10px] mobile:w-full mobile:px-[20px] tablet:w-full tablet:py-[20px]'>

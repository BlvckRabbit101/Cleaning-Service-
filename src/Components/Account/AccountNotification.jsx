...
const AccountNotification = () => {
  ...
  return (
    ...
    <HiOutlineBell className='cursor-pointer duration-300 mobile:hidden tablet:hidden hover:text-[#4291fd]' fontSize="24px"  />
    ...
    <div className={`${change? 'visible' : 'invisible'} duration-150 `}
      ...
      onMouseLeave={() => setChange('not-change')}>
        ...
        <div className='absolute h-auto w-[330px] top-10 right-1 border rounded-md py-4  flex justify-center items-center bg-white font-medium '>
          ...
          <div className='w-[90%]'>
            <div className='cursor-pointer flex py-2 h-10 w-full gap-2 justify-center items-center text-black'>

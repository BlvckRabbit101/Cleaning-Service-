...
const OurServicesCard = (props) => {
  return (
    <div className='w-[340px] h-[285px] flex justify-center items-center rounded bg-white text-[#032B56] mobile:w-full mobile:h-auto tablet:w-full tablet:h-auto '>
        <div className='p-[20px] flex justify-center items-start gap-[15px] mobile:flex-col tablet:flex-col'>
            ...
            <div className='w-[75%] flex flex-col justify-start items-start mobile:w-full' >
                <div className='text-[24px] mb-[15px] hover:text-[#4291FD] cursor-pointer duration-700'>{props.title}</div>
                <div className='text-[16px] text-[#333] font-normal leading-[27px] mb-[20px]'>{props.text}</div>
